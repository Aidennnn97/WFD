...
public class BundesligaController {
   ...
   @RequestMapping("/bundesliga")
      public String bundesligaJsp(Model model) {
      ...
      //   오늘 경기 일정 크롤링 데이터 
      @RequestMapping("/craw/bundesligaPlan.ajax")
      @ResponseBody
      ...
      @RequestMapping("/craw/clickBundesligaMatchData.ajax")
      @ResponseBody
      public ArrayList<HashMap<String, String>> bundesligaMatchDetail(String gameId)throws Exception {
         // 경기 상세 정보 크롤링 모듈.
      ...
      // 전체 팀 순위 크롤링 데이터 
      @RequestMapping("/craw/bundesligaTeamRank.ajax")
      @ResponseBody
      public ArrayList<HashMap<String, String>> bundesligaTeamRank()throws Exception {

         return BundesligaDataStorage.getBundesligaTeamRankData();

      }


      // 전체 선수 순위 크롤링데이터 
      @RequestMapping("/craw/bundesligaPlayerRank.ajax")
      @ResponseBody
      public ArrayList<HashMap<String, String>> bundesligaPlayerRank()throws Exception {

         return BundesligaDataStorage.getBundesligaPlayerRankData();
      ...
      @RequestMapping("/craw/bundesligaPlayerAsistRank.ajax")
      @ResponseBody
      public ArrayList<HashMap<String, String>> bundesligaPlayerAsistRank()throws Exception {
         
         return BundesligaDataStorage.getBundesligaPlayerAsistRankData();
         
      }
      

      //팀 내 모든선수 크롤링데이터 
      @RequestMapping("/craw/innerBundesligaPlayerRank.ajax")
      @ResponseBody
      public ArrayList<HashMap<String, String>> innerBundesligaPlayerRank(String teamId)throws Exception{
         // 모든 팀 내의 선수단 정보를 받아올 그릇 (리그 내 전체 선수 데이터)
               ...
               try {
                  ...
                  // 팀 상세페이지의 데이터 크롤링 주소 
                  String url = "https://sports.daum.net/prx/hermes/api/person/list.json?leagueCode=bundesliga&seasonKey=20222023&teamId="+ teamId +"&detail=true&pageSize=100";
