...
public class EplPlayerAsistRankCrawling {
	public ArrayList<HashMap<String, String>> eplPlayerAsistRank()throws Exception {
		...
		String url = "https://sports.daum.net/prx/hermes/api/person/rank.json?leagueCode=epl&seasonKey=20222023&page=1&pageSize=100&sort=ast";
