...
public class BundesligaMatchScheduleCrawling {

   // Epl 경기 일정 크롤링 모듈.
   public ArrayList<HashMap<String, String>> bundesligaMatchScheduleCrawling()throws Exception {
      ...
      try {
         ...
         ArrayList<HashMap<String,Object>> matchList2 = (ArrayList<HashMap<String, Object>>) matchList.get("20221112");
         ...
         if(matchList2 != null) {
            ...
            for(int i = 0; i < matchList2.size(); i++) {
               ...
               if(leagueName.equals("분데스리가") && homeResult != null) {
