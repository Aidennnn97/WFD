...
public class BundesligaPlayerAsistRankCrawling {
   public ArrayList<HashMap<String, String>> bundesligaPlayerAsistRank()throws Exception {
      ...
      String url = "https://sports.daum.net/prx/hermes/api/person/rank.json?leagueCode=bundesliga&seasonKey=20222023&page=1&pageSize=100&sort=ast";
