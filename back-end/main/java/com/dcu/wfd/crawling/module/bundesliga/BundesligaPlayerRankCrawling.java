package com.dcu.wfd.crawling.module.bundesliga;
...
public class BundesligaPlayerRankCrawling {
   public ArrayList<HashMap<String, String>> bundesligaPlayerRank()throws Exception {
      ...
      String url = "https://sports.daum.net/prx/hermes/api/person/rank.json?leagueCode=bundesliga&seasonKey=20222023&page=1&pageSize=100&sort=gf";
      ...
      BundesligaDataStorage.setBundesligaInnerPlayerRankData(trCrawlingDataList2);
