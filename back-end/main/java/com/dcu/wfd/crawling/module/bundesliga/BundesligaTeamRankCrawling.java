...
public class BundesligaTeamRankCrawling {
   public ArrayList<HashMap<String, String>> bundesligaTeamRankCrawling() throws Exception { 
      
      ArrayList<HashMap<String, String>> trCrawlingDataList = new ArrayList<>();
      HttpUtil httpUtil = new HttpUtil();
      String url = "https://sports.daum.net/prx/hermes/api/team/rank.json?leagueCode=bundesliga&seasonKey=20222023&page=1&pageSize=100";
      try {
