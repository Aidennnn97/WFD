...
public class LaligaMatchScheduleCrawling {

   // Epl 경기 일정 크롤링 모듈.
   public ArrayList<HashMap<String, String>> laligaMatchScheduleCrawling()throws Exception {
      ...
      try {
         ...
         ArrayList<HashMap<String,Object>> matchList2 = (ArrayList<HashMap<String, Object>>) matchList.get("20221111");
         ...
         if(matchList2 != null) {
            ...
            for(int i = 0; i < matchList2.size(); i++) {
               ...
               if(leagueName.equals("라리가") && homeResult != null) {
