...
public class LaligaPlayerAsistRankCrawling {
   public ArrayList<HashMap<String, String>> laligaPlayerAsistRank()throws Exception {
      ...
      String url = "https://sports.daum.net/prx/hermes/api/person/rank.json?leagueCode=primera&seasonKey=20222023&page=1&pageSize=100&sort=ast";
