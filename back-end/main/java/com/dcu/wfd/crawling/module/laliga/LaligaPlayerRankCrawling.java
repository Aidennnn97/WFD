package com.dcu.wfd.crawling.module.laliga;
...
public class LaligaPlayerRankCrawling {
   public ArrayList<HashMap<String, String>> laligaPlayerRank()throws Exception {
      ...
      String url = "https://sports.daum.net/prx/hermes/api/person/rank.json?leagueCode=primera&seasonKey=20222023&page=1&pageSize=100&sort=gf";
      ...
      LaligaDataStorage.setLaligaInnerPlayerRankData(trCrawlingDataList2);
