...
public class LaligaTeamRankCrawling {
   public ArrayList<HashMap<String, String>> laligaTeamRankCrawling() throws Exception { 
      
      ArrayList<HashMap<String, String>> trCrawlingDataList = new ArrayList<>();
      HttpUtil httpUtil = new HttpUtil();
      String url = "https://sports.daum.net/prx/hermes/api/team/rank.json?leagueCode=primera&seasonKey=20222023&page=1&pageSize=100";
      try {
