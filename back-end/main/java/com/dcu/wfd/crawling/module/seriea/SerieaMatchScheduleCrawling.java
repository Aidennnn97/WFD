...
public class SerieaMatchScheduleCrawling {

   // Epl 경기 일정 크롤링 모듈.
   public ArrayList<HashMap<String, String>> serieaMatchScheduleCrawling()throws Exception {
      ...
      try {
         ...
         if(matchList2 != null) {
            ...
            for(int i = 0; i < matchList2.size(); i++) {
               ...
               if(leagueName.equals("세리에A") && homeResult != null) {
