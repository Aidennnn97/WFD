...
CREATE TABLE `Home_player` (
  ...
  KEY `FK_Home_TO_Home_player_2` (`team_id`),
  CONSTRAINT `FK_Home_TO_Home_player_1` FOREIGN KEY (`match_id`) REFERENCES `Home` (`match_id`),
  CONSTRAINT `FK_Home_TO_Home_player_2` FOREIGN KEY (`team_id`) REFERENCES `Home` (`team_id`)
