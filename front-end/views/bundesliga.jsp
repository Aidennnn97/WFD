...
<body>
   ...
   <script type="text/javascript">
             ...
             $(document).ready(function(){
                 ...
                 $.ajax({
                     ...
                     success:function(data3){
                        ...
                        if(cnt ==0){
                           ...
                           $.ajax({
                              url:"/craw/clickBundesligaMatchData.ajax",
                              dataType: "json",
                              type: "post",
                              data:{
                                 gameId : gameId,
                  ...
                  $.ajax({
                     url: "/craw/bundesligaTeamRank.ajax",
                     dataType : "json",
                     type : "post",
                     async: false,
                ...
                //dataContext에서 팀id를 가지고 innerPlayerRank.ajax에서 받아온 데이터와 비교
                   ...
                   function innerPlayerRank (tId, callback) {
                      $.ajax({
                           url:"/craw/innerBundesligaPlayerRank.ajax",
                           dataType: "json",
                           type: "post",
                           data:{
                              teamId : tId, 
         ...
         /*                  panX: false,
                     ...
                     /* bubble chart start */
                     $.ajax({
                         url: "/craw/bundesligaPlayerAsistRank.ajax",
                         dataType : "json",
                         type : "post",
                         async: false,
                  ...
                  var barData = [
                     {
                       ...
                       name: data[16].teamName,
                       steps: parseInt(data[16].teamPts),
                       pictureSettings: {
                         src: data[16].teamImg
                       },
                  ...
                  chart.appear(1000, 100);
                   ...
                   /* 전체선수 테이블 20명까지  */  
                   $.ajax({
                      url: "/craw/bundesligaPlayerRank.ajax",
                      dataType : "json",
                      type : "post",
                      async: false,
                      success:function(data){
