...
<body>
   ...
   <script type="text/javascript">
             ...
             $(document).ready(function(){
                 ...
                 $.ajax({
                     ...
                     success:function(data3){
                        ...
                        if(cnt ==0){
                           ...
                           $.ajax({
                              url:"/craw/clickSerieaMatchData.ajax",
                              dataType: "json",
                              type: "post",
                              data:{
                                 gameId : gameId,
                ...
                //dataContext에서 팀id를 가지고 innerPlayerRank.ajax에서 받아온 데이터와 비교
                   ...
                   function innerPlayerRank (tId, callback) {
                      $.ajax({
                           url:"/craw/innerSerieaPlayerRank.ajax",
                           dataType: "json",
                           type: "post",
                           data:{
                              teamId : tId, 
         ...
         /*                  panX: false,
                     ...
                     /* bubble chart start */
                     $.ajax({
                         url: "/craw/serieaPlayerAsistRank.ajax",
                         dataType : "json",
                         type : "post",
                         async: false,
                  ...
                  chart.appear(1000, 100);
                   ...
                   /* 전체선수 테이블 20명까지  */  
                   $.ajax({
                      url: "/craw/serieaPlayerRank.ajax",
                      dataType : "json",
                      type : "post",
                      async: false,
                      success:function(data){
